...
From the graph above we can see that the relationship between power and
the true mean is sigmoidal.Power is increasing as true mean increases

A plot showing the average estimage of mu-hat on the y axis and the true
value of mu-jat on the axis as well as a second plot of the average
estime of muhat in samples where the null was rejected on the y axis and
...
The sample average of mu-hat is approximately equal to the true value of
mu since the dataset was created based on the true value of mu.
